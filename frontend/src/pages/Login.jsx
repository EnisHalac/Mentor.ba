    ...
    <div className="flex flex-col md:flex-row min-h-screen w-full bg-[#f0f2f5] font-sans overflow-x-hidden">
      ...
      <div className="flex-1 flex justify-center items-center p-6 md:p-12 animate-slideInRight">
        <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-[400px] animate-cardFade">
          <h2 className="text-2xl font-bold mb-6 text-gray-800">Prijava</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-1 relative">
              ...
              <div className="relative flex items-center">
                <input type={showPassword ? "text" : "password"} name="password" title="password" className="w-full p-3 pr-12 border border-[#dddfe2] rounded-md focus:outline-blue-500" placeholder="Unesite lozinku" onChange={handleChange} onKeyDown={checkCapsLock} onKeyUp={checkCapsLock} required />
            ...
            <button type="submit" className="w-full p-3 bg-[#1877f2] text-white rounded-md text-xl font-bold hover:bg-[#166fe5] transition-colors mt-2">
              Prijavi se
            </button>
          </form>
